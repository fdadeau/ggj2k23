...
const TEQUILA_HEIGHT = 724/3 | 0;
const TEQUILA_DRINK = [0,1,2];
...
class Tequila extends Consumable {
    constructor(){
        super(3,FRAME_DELAY*3);
        this.setAnimation(TEQUILA_DRINK); // Change animation
    }
    ...
    render(ctx){
        ctx.drawImage(TEQUILA_SPRITESHEET, 0, ((this.animation[this.frame]) * TEQUILA_HEIGHT), 240, 236, 400, 325-150, 170, 150); // TODO : make it clean (temporary, wait final textures)
    }
}
